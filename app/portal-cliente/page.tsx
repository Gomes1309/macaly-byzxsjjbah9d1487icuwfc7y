...
const loadFallbackData = async () => {
  try {
    ...
    const fallbackData: ResponsavelPortal[] = [{
      ...
      senhaInicial: true,
      empresaId: 'emp_001',
      empresaNome: 'LEG - COMÉRCIO E SERVIÇOS LTDA',
...
export default function PortalClientePage() {
  ...
  const handlePasswordRecovery = async () => {
    ...
    try {
      // Simular chamada da API para envio de email de recuperação
      console.log('Enviando email de recuperação para:', recoveryData.email)
      ...
      if (result.success) {
        ...
        setRecoveryError(result.message || 'Erro ao enviar email de recuperação')
      }
