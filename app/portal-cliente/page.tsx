...
export default function PortalClientePage() {
  ...
  const handleLogin = async () => {
    try {
      ...
      console.log('📋 Dados do formulário:', { cpf: cpf, senhaLength: senha.length })
      ...
      console.log('🔍 Procurando responsável com CPF:', cpfNumeros)
      console.log('📋 CPFs disponíveis:', responsaveis.map(r => r.cpf.replace(/\D/g, '')))
            ...
            <CardContent className="p-8 space-y-6">
              ...
              {process.env.NODE_ENV === 'development' && (
                <div className="bg-gray-50 p-4 rounded-lg border">
                  <h3 className="text-sm font-semibold text-gray-700 mb-2">🛠️ Debug - Desenvolvimento</h3>
                  <div className="space-y-2 text-xs text-gray-600">
                    <p><strong>CPF de teste:</strong> 218.680.918-48</p>
                    <p><strong>Senha de teste:</strong> 22HHgYhJ</p>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {/* Seção Informativa sobre Segurança e Backups */}
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-green-700 text-sm">
                    A AG Assessoria realiza backups automáticos diários de todos os seus documentos e dados. 
                    Sua informação está protegida e sempre disponível quando você precisar.
                  </p>
                </div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-green-600">✓</div>
                <div className="text-xs text-green-600 font-medium">Backup Ativo</div>
              </div>
            </div>
          </CardContent>
        </Card>
