...
export default function GestaoPortalClientesPage() {
  ...
  const handleCreateResponsavel = async () => {
    ...
    try {
      ...
      // Toast mais destacado com a senha
      toast.success(
        <div className="flex flex-col">
          <span className="font-medium">Responsável criado com sucesso!</span>
          ...
          <span className="text-xs text-gray-600 mt-1">
            O responsável deve alterar esta senha no primeiro acesso
          </span>
        </div>,
  ...
  // Resetar senha
  const handleResetPassword = (responsavel: ResponsavelPF) => {
    ...
    toast.success(
      <div className="flex flex-col">
        <span className="font-medium">Nova senha gerada!</span>
        <div className="mt-2 p-2 bg-yellow-100 rounded border border-yellow-300">
          <span className="text-sm text-yellow-800">
