...
export default function DashboardAbertura() {
  ...
  const confirmDeleteProcesso = useCallback(() => {
    ...
    toast({
      ...
      description: `O processo ${selectedProcesso.nomeEmpresa} foi removido permanentemente.`,
      variant: "destructive",
    })
              ...
              <CardContent className="p-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <span className="text-lg font-medium">Alteração de Empresa</span>
                    <span className="text-sm opacity-90">Modificar dados cadastrais</span>
                  </Button>
                </div>
              </CardContent>
            </Card>
