...
export default function DashboardAbertura() {
  ...
  const generateDocumentsPDF = () => {
    ...
    pdf.setFontSize(12)
    pdf.text('CONTABILIDADE E ASSESSORIA EMPRESARIAL', 20, 28)
    
    // Document title
    pdf.setFontSize(18)
    pdf.setTextColor(0, 0, 0)
    pdf.text('DOCUMENTOS NECESSÁRIOS PARA ABERTURA DE EMPRESA', 20, 55)
    
    // Date
    pdf.setFontSize(10)
    pdf.text(`Gerado em: ${format(new Date(), 'dd/MM/yyyy HH:mm')}`, 20, 65)
    ...
    pdf.setFontSize(8)
    pdf.setTextColor(128, 128, 128)
    pdf.text('AG Assessoria - Documentos necessários para abertura de empresa', 20, 280)
