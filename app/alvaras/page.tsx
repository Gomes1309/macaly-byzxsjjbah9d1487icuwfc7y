  ...
  const sendNotification = useCallback(async () => {
    ...
    try {
      ...
      const notificationData = {
        clienteEmail: selectedAlvara.contato,
        clienteNome: selectedAlvara.clienteId ? getClienteNome(selectedAlvara.clienteId) : 'Cliente',
      ...
      toast({
        ...
        description: `Email enviado para ${selectedAlvara.contato} sobre o alvará da empresa ${selectedAlvara.empresa}.`,
      })
