      ...
      <div ref={ref} className="bg-white p-8 text-black" style={{ fontSize: '12px', lineHeight: '1.4' }}>
        ...
        <div className="border-b-2 border-gray-800 pb-6 mb-6">
          <div className="flex justify-between items-start">
            <div>
              <h1 className="text-2xl font-bold text-gray-800 mb-2">AG ASSESSORIA</h1>
              <h2 className="text-lg font-semibold text-blue-600 mb-1">Relatório de Obrigações Fiscais</h2>
        ...
        <div className="border-t border-gray-300 pt-4 mt-8">
          <div className="flex justify-between items-center text-sm text-gray-600">
            <div>
              <p><strong>AG Assessoria</strong> - Sistema de Gestão de Obrigações Fiscais</p>
